...
###### Loại bỏ Insulin
Loại bỏ thuộc tính Insulin và quan sát thấy mô hình thu được có độ chính xác và độ nhạy cao hơn mô hình ban đầu
```{r}
...
Loại bỏ thêm 2 thuộc tính SkinThickness và Pregnancies thấy mô hình tăng độ chính xác, độ nhạy và độ đặc hiệu. Quyết định chấp nhận mô hình với độ chính xác ~85% và độ nhạy ~0.76, độ đặc hiệu ~0.89
```{r}
